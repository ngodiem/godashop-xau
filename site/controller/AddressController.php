<?php 
// dùng ajax vd được mã tỉnh lên đổ thông tin quận/huyện ra
class AddressController {
	...
	function getShippingFee() {
		$province_id = $_GET["province_id"];
		$provinceRepository = new ProvinceRepository();
		$province = $provinceRepository->find($province_id); // từ mã tỉnh tìm được phí 
		echo $province->getShippingFee(); // dựa vào mã tính lấy phó
	}
