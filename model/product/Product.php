...
class Product {
	...
	function getId() { // get lấy ra set nhập vào
		return $this->id;
	}
	...
	function getBarcode() { // mã vạch duy nhất
		return $this->barcode;
	}

	function getSku() { // vị trí sp trên kệ hàng
		return $this->sku;
	}

	function getPrice() { // giá thông thường
		return $this->price;
	}

	function getDiscountPercentage() { // giá khuyến mãi
	...
	function getCreatedDate() { // sp nhập về ngày nào
	...
	function getFeatured() { // sp nổi bật
		return $this->featured;
	}

	function getCategoryId() { // danh mục sp
